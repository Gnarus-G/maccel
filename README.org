* Description
  This fork of =LEETMOUSE= by chilliams and systemofapwne adds in Classic acceleration and changes the functionality of sensitivity to behave more like RawAccel. It is supported by the in-progress GUI tool https://github.com/Skyl3r/leetmouse-gui.
  Currently post/pre scale does nothing, sensitivity cap does nothing and scrolls per tick does nothing.
